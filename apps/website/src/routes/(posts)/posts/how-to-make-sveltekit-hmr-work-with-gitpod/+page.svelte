...
<p>
	<strong>This post is outdated. HMR works just fine on Gitpod with SvelteKit 1.x.</strong>
</p>
...
<p>
	...
	>. In a Gitpod workspace, the SvelteKit development server runs on port 5173, like in your local
	development environment. How you access the development server depends on how you access your
	Gitpod workspace:
</p>
...
<p>
	...
	<a href="https://github.com/sveltejs/kit/issues/2519#issuecomment-947485636">last issue comment</a
	> points to the solution. You can customize the Vite configuration and override its default HMR behavior.
</p>

<p>The <a href="https://vitejs.dev/config/#server-hmr">Vite docs</a> explain that</p>

<blockquote>
	<p>
		<code>clientPort</code> is an advanced option that overrides the port only on the client side, allowing
		you to serve the websocket on a different port than the client code looks for it on. Useful if you're
		using an SSL proxy in front of your dev server.
	</p>
</blockquote>
...
<p>
	...
	<a href="https://www.gitpod.io/docs/environment-variables#default-environment-variables"
		><code>GITPOD_WORKSPACE_URL</code></a
...
<figure>
	<Highlight
		language={plaintext}
		code={`https://maiertech-maiertech-ti2zaqimh33.ws-us34.gitpod.io/`}
	/>
</figure>
...
<figure>
	<Highlight
		language={plaintext}
		code={`https://5173-maiertech-maiertech-ti2zaqimh33.ws-us34.gitpod.io/`}
	/>
</figure>

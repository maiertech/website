...
export async function load({ fetch }) {
	...
	return {
		title: 'Thilo Maier',
		description:
			"Hi, I'm Thilo. I am a developer and creator based in Rotterdam, Netherlands. I build web apps with SvelteKit and Svelte and keep improving my developer happiness.",
		topics
	};
}

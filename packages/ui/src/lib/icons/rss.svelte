<script>
	...
	export let title = 'RSS';
	export { className as class };
</script>

<svg fill="currentColor" viewBox="0 0 512 512" class={className}>
	<title>{title}</title>
	<path d="M108.56 342.78a60.34 60.34 0 1 0 60.56 60.44a60.63 60.63 0 0 0-60.56-60.44Z" />
	<path

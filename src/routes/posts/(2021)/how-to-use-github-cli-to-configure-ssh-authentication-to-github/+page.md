...
description:
  Configure SSH authentication for GitHub command-line access with the GitHub CLI. Covers key
  generation, uploading, and verifying your connection.
tags:
  - github
---
...
If you do not have GitHub CLI installed, you can install it with `brew install gh`. Run
`gh auth login` and answer the prompts. Choose SSH as the preferred protocol. You do not need to
enter a password for the generated SSH key. Just hit <key>↵</key>:

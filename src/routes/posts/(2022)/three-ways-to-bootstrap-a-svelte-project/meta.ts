...
export default {
	...
	description:
		'Explore three ways to start a Svelte project. Only StackBlitz offers the official Vite Svelte templates; Svelte REPL and CodeSandbox use deprecated ones.',

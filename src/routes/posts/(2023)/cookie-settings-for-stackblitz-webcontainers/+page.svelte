<script lang="ts">
	import { Code, Figure, P, ResponsiveImage } from '@maiertech/sveltekit-helpers';
...
<P>
	...
	</a>. The first catch with WebContainers is that they are
...
<P>
	...
	<a href="/posts/is-stackblitz-codeflow-beta-ready-to-replace-your-local-vs-code">
		Is StackBlitz Codeflow Beta ready to replace your local VSCode?
	</a>, you have to add <Code>[*.]staticblitz.com</Code> to the above list to make it work without enabling

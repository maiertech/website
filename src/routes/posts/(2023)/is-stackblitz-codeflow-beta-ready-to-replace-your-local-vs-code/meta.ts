...
export default {
	...
	description:
		'StackBlitz Codeflow Beta brings VS Code to browsers with WebContainers, offering promising disposable workspaces despite current Node.js and extension limits.',
	tags: ['dx', 'stackblitz'],

...
<p>
	...
	>. In this post, I explained Gitpod's one-workspace-per-task philosophy.
</p>
...
<figure>
	...
	<figcaption>
		...
		launch a Codeflow workspace for a pull request review.
	</figcaption>
</figure>
...
<p>
	...
	<a href="https://marketplace.visualstudio.com/vscode"
		>Microsoft's marketplace for VS Code extensions</a
...
<p>
	When you run <code>npm</code> in a Codeflow workspace, you run StackBlitz's
	<a
